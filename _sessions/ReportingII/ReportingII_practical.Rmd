...
1. Grafiken formatiert.
3. Datentabellen einfügt und im Detail gestaltet.
4. Ergebnisse eines Regressionsmodells einbindet.

## Aufgaben

### A - Setup

1. Öffne dein `TheRBootcamp` R Projekt. Es sollte die Ordner `1_Data`, `2_Code`, und `3_Figures` enthalten. 

2. Lade die `airbnb_level_one.Rmd` Datei, das fertige Produkt am Ende des ersten Markdown Practicals. 

3. Speichere die Datei und dem neuen Namen: `airbnb_level_two.Rmd` ab.

4. Zusätzlich lade die Pakete `knitr`, `kableExtra` und `sjPlot` im `setup` chunk. 
...
Der [airbnb.csv](https://raw.githubusercontent.com/therbootcamp/RmR_2020Nov/master/_materials/case/1_Data/airbnb.csv) Datensatz enthält Zahlen zu 9868 Berliner Airbnbs 
