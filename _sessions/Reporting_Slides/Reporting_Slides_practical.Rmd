...
1. Eine HTML Präsentation mit `ioslides` erstellt und Inhalte mit RMarkdown Code einfügt.
2. Ein Logo einfügt und das Layout der Präsentation anpasst.
3. HTML Tags und CSS für die Feinjustierung der Slides verwendet.
...
5. Achte darauf, dass die Einrückungen korrekt sind. Der YAML Header sollte so aussehen:
...
5. Tip zum Entfernen der Warnungen: `message`.
...
4. Auf dem gleichen Slide, unter der Tabelle, füge den letzten Satz des Abschnittes "Der Einfluss der Ausstattung" zum stark negativen Effekt der Küche ein. Füge HTML Code ein, der die Schrift fett formatiert.
